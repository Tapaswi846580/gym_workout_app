...
class RandomMode extends StatefulWidget {
  @override
  _RandomModeState createState() => _RandomModeState();
}

class _RandomModeState extends State<RandomMode> with SingleTickerProviderStateMixin{
  ...
  getList(){
    WidgetsBinding.instance.addPostFrameCallback((_){
      setState(() {
        listOfExercise = resources.loadRandomExercises();
      });
      askForNumberOfSets();
    });
  }
...
//                          height: _height / 4,
      ...
      floatingActionButton: AbsorbPointer(
        ...
        child: FloatingActionButton(
          ...
          child: AnimatedIcon(icon: AnimatedIcons.play_pause, color: _theme.backgroundColor, progress: _controller),),
      ),
    );
  }
